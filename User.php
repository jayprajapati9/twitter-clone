...
if (empty($_GET['u']) || $_GET['u'] == "" || $_GET['u'] == Null) {
    header('Location: Home.php');
}

if (isset($_GET['u'])) {
    $getUsername = htmlspecialchars(mysqli_real_escape_string($conn, $_GET['u']));
    ...
    <main class="MainContent">
        ...
        <div class="Main">
            ...
            <div class="ProfileBody">
                <div class="ProfilePic_N_Button">
                    ...
                    $query2 = mysqli_query($conn, "SELECT * FROM connection WHERE follower='$sessionUsername' AND following='$user_name'");
                    mysqli_close($conn);
                    if (mysqli_num_rows($query2) >= 1) {
                        echo "<a href='Unfollow.php?username=$user_name' >Unfollow</a>";
                    } else {
                        echo "<a href='Follow.php?username=$user_name' >Follow</a>";
                    }
                    ?>
                </div>
                <div class="Profile_Info">
                    ...
                    <span>
                        ...
                        if (!empty($user_location)) {
                            echo "<i class='material-icons'>place</i> $user_location 
            ...
            <?php
            include 'connection.php';
            $GetTweetquery = mysqli_query($conn, "SELECT * FROM tweets WHERE username = '$getUsername' ORDER BY tweetid DESC;");
        ...
        <div class="RightSideDiv">
            ...
            <div class="BrandPromo_Card">
                ...
                <p>@jayprajapati</p>
                <p>Sign up now to get your own personalized timeline!</p>
                <button onclick="location.href='jayprajapati';">Follow</button>
            </div>
        </div>
    </main>
    <script>
